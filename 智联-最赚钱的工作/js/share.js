...
var app_title = " 史上最赚钱的工作";
var app_desc = "听说最赚钱的工作都在这里了！";
var tl_title = "听说最赚钱的工作都在这里了！";
//微信分享s
var DOMAIN="http://weixin.fengme.cc/app/money/";
...
wx.ready(function(){
	...
	wx.onMenuShareTimeline({
		title: tl_title, 		// 分享标题
		link: link, 					// 分享链接
		imgUrl: DOMAIN+"/images/share.jpg",	// 分享图标
		success: function () {
			//用户分享成功后执行的回调函数
