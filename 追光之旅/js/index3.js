...
function redraw() {
	var cha = height*0.35;
	ctx.clearRect(0,0,width,1024);
	ctx.fillStyle="rgba(255, 255, 255, 0)";
	ctx.fillRect(0, 0, width, 1024);
	...
	ctx.drawImage(img,config[frame+'.png'].frame.x,config[frame+'.png'].frame.y,config[frame+'.png'].frame.w,config[frame+'.png'].frame.h, width-config[frame+'.png'].spriteSourceSize.w*bi, config[frame+'.png'].spriteSourceSize.y*bi-width*height/10240-5, config[frame+'.png'].spriteSourceSize.w*bi,config[frame+'.png'].spriteSourceSize.h*bi);
}
